...
void FMap::GetNextAssoc(POSITION& rNextPosition,void*& rKey, void*& rValue) const
{
...
POSITION FPtrList::AddHead(void* newElement)
{
...
POSITION FPtrList::AddTail(void* newElement)
{
...
POSITION FPtrList::InsertBefore(POSITION position, void* newElement)
{
...
POSITION FPtrList::InsertAfter(POSITION position, void* newElement)
{
...
void FPtrList::RemoveAt(POSITION position)
{
...
POSITION FPtrList::FindIndex(int nIndex) const
{
...
POSITION FPtrList::Find(void* searchValue, POSITION startAfter) const
{
...
void FArray::SetSize(int nNewSize, int nGrowBy)
{
	assert(nNewSize >= 0);
...
int FArray::Append(const FArray& src)
{
...
void FArray::Copy(const FArray& src)
{
	assert(this != &src);   // cannot append to itself
	SetSize(src.m_nSize);
...
void FArray::SetAtGrow(int nIndex, void* newElement)
{
	assert(nIndex >= 0);
...
void FArray::InsertAt(int nIndex, void* newElement, int nCount)
{
...
void FArray::InsertAt(int nStartIndex, FArray* pNewArray)
{
